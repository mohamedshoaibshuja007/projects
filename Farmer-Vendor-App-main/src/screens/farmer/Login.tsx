...
const FarmerLogin = ({ navigation }: Props) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // After successful login, navigate to FarmerNavigator
      navigation.reset({
        index: 0,
        routes: [{ name: 'FarmerNavigator' }],
      });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.linksContainer}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('FarmerForgotPassword')}
          style={styles.link}
        >
